...
uav_positions = np.array([[100, 100], [300,100], [500, 100], [100, 300], [300, 300], [500, 300],[100, 500],[300, 500], [500, 500]])
...
#                      [100, 700], [300, 700], [500, 700], [700, 700]], dtype=np.float)
# uav_positions = np.array(
#                     [[80, 50], [160, 50], [240, 50], [320, 50],
#                      [400, 50], [480, 50], [560, 50], [640, 50],
#                      [50, 80], [50, 160], [50, 240], [50, 320],
#                      [50, 400], [50, 480], [50, 560], [50, 640]], dtype=np.float)

# uav_positions = np.array(
#                     [[80, 80], [240, 80], [400, 80],
#                      [80, 240], [240, 240], [400, 240],
#                      [80, 400], [240, 400], [400, 400]], dtype=np.float)
# uav_positions = np.array(
#                     [[110, 110], [330, 110], [550, 110],
#                      [110, 330], [330, 330], [550, 330],
#                      [110, 550], [330, 550], [550, 550]], dtype=np.float)
# uav_positions = np.array(
#                     [[110, 110], [330, 110], [550, 110],[770, 110],
#                      [110, 330], [330, 330], [550, 330],[770, 330],
#                      [110, 550], [330, 550], [550, 550],[770, 550],
#                     [110, 770], [330, 770], [550, 770],[770, 770],
#                      ], dtype=np.float)
# uav_positions = np.array(
