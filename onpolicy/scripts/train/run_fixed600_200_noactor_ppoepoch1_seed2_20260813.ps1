...
if (-not $ExperimentName) {
    $ExperimentName = 'dcppoR520_fixed600_200_layoutctx_noactor_peragentnoise_s3p0_md12_vmax30_ppoepoch1_seed2_60m_20260813'
}
...
& $common -NoiseScale 3.0 -Seed 2 -NumEnvSteps $NumEnvSteps `
    ...
    -ClipParam 0.15 -Gamma 0.99 -PpoEpoch 1 `
