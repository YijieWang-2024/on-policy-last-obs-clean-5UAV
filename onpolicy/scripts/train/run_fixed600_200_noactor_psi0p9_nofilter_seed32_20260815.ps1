...
& $common `
    ...
    -ActorMessageContract absolute_raw_v2 -AssociationThreshold 0.9 `
    -DisableOffloadDeadlineFilter -UserName $UserName `
    -ExperimentName 'dcppoR520_fixed600_200_layoutctx_noactor_peragentnoise_s3p0_md12_vmax30_psi0p9_nofilter_seed32_60m_20260815'
exit $LASTEXITCODE
