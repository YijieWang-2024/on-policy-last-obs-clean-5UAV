...
def parse_args(args, parser):
    ...
    parser.add_argument("--C_min", type=int, default=700 * 10 ** 6, help="Minimum resource demand of generated tasks in 900 Megacycles")
    ...
    parser.add_argument("--Dis_min", type=int, default=8, help="Minimum collision avoidance distance between UAV servers in meters")
