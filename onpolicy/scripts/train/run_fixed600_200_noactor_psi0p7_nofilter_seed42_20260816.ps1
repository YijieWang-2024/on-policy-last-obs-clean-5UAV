...
& $common `
    -NoiseScale 3.0 -Seed 42 -NumEnvSteps 60000000 -RolloutThreads 64 `
    ...
    -ActorMessageContract absolute_raw_v2 -AssociationThreshold 0.7 `
    -DisableOffloadDeadlineFilter -UserName $UserName `
    -ExperimentName 'dcppoR520_fixed600_200_layoutctx_noactor_peragentnoise_s3p0_md12_vmax30_psi0p7_nofilter_seed42_60m_20260816'
exit $LASTEXITCODE
