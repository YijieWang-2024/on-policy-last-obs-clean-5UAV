...
# Seed-42 no-deadline-filter psi sweep.  All other arguments remain matched
# to the Fixed600-200 / lifetime-12 / noise-3 / R520 baseline.
exec "$python_bin" "$train_script" \
  --env_name mec --algorithm_name mappo --user_name wyj2 --seed 42 --share_policy \
