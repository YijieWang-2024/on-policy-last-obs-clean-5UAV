...
& $common `
    -NoiseScale 3.0 -Seed 32 -NumEnvSteps 60000000 -RolloutThreads 64 `
    ...
    -ExperimentName 'dcppoR520_fixed600_200_layoutctx_noactor_peragentnoise_s3p0_md12_vmax30_psi0p7_nofilter_seed32_60m_20260815'
exit $LASTEXITCODE
