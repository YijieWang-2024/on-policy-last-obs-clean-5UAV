...
# F600-B0 proposed method: unreliable data plane with natural MD replay and
# per-receiver/session GRU reconstruction for the critic.
...
& $launcher `
    ...
    -RunningSumRounds 50 `
    -MDGRUTrainSamples 512 `
    -MDGRUMinReadySamples 512 `
    ...
    -Python $python `
    -ExperimentName 'F600_B0_proposed_unreliable_mdgru_seed2_60m_cuda'
