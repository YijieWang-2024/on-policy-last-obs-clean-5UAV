...
& $launcher `
    -Seed 21 -NumEnvSteps 60000000 -RolloutThreads 64 `
    ...
    -ExperimentName 'F600_B0_unreldp_unreliable_last_obs_nocurr_deadlineon_a2atimelyp50_pa_s3_seed21_60m_cuda'
if ($LASTEXITCODE -ne 0) { throw "Unreliable last-observation A2A-timely-p50 seed-21 training exited with code $LASTEXITCODE." }
