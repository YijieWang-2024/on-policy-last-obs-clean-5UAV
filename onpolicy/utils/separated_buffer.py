...
class SeparatedReplayBuffer(object):
    def __init__(self, args, obs_space, share_obs_space, act_space, available_actions_space=None):
        ...
        self.available_actions = np.ones(
            (self.episode_length + 1, self.n_rollout_threads, available_actions_space), dtype=np.float32)
    ...
    def recurrent_generator(self, advantages, num_mini_batch, data_chunk_length):
        ...
        attention_active_mask = _cast(self.attention_active_mask[:-1])
        ...
        for indices in sampler:
            ...
            for index in indices:
                ...
                attention_active_mask_batch.append(attention_active_mask[ind:ind+data_chunk_length])
            ...
            attention_active_mask_batch = np.stack(attention_active_mask_batch)
            ...
            attention_active_mask_batch = _flatten(L, N, attention_active_mask_batch)
