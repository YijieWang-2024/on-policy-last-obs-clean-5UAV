"""Plot the completed clip-parameter sensitivity against the matched baseline."""
...
CURVES = [
    ("Baseline · clip=0.15 · seed=2", DATA / "baseline_R520_seed2.tfevents", "#0072B2", "-"),
    ("Variant · clip=0.05 · seed=32", DATA / "clip0p05_seed32.tfevents", "#E69F00", "--"),
    ("Variant · clip=0.30 · seed=32", DATA / "clip0p3_seed32.tfevents", "#CC79A7", "-.") ,
]
...
def main() -> None:
    ...
    ax.set_title("PPO sensitivity: clip parameter", pad=10)
