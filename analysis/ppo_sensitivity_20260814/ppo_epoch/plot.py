"""Plot the completed PPO-epoch sensitivity against the matched baseline."""
...
CURVES = [
    ("Baseline · ppo_epoch=4 · seed=2", DATA / "baseline_R520_seed2.tfevents", "#0072B2", "-"),
    ("Variant · ppo_epoch=1 · seed=32", DATA / "ppoepoch1_seed32.tfevents", "#E69F00", "--"),
    ("Variant · ppo_epoch=10 · seed=32", DATA / "ppoepoch10_seed32.tfevents", "#CC79A7", "-.") ,
]
...
def main() -> None:
    ...
    ax.set_title("PPO sensitivity: update epochs", pad=10)
