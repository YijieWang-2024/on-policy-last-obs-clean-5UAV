"""Evaluate the six live runs on three common deterministic episodes."""
...
def load_base():
    spec = importlib.util.spec_from_file_location("association_eval_six_20260817", BASE_SCRIPT)
