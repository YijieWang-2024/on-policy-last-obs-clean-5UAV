"""Evaluate the five requested curriculum-on checkpoints on three common episodes.

This reuses the project's established trajectory evaluator and freezes local
checkpoints once before inference.  Remote checkpoints are the fresh snapshots
downloaded beside this script.
"""
...
def main() -> None:
    ...
    module.OUTPUT = HERE / "trajectory_eval_3_latest_20260817"
    ...
    for psi in ("0p5", "0p7", "0p9"):
        snapshot = remote_root / f"remote_psi{psi}" / "checkpoint_snapshot"
