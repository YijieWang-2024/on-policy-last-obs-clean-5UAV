"""Plot the five requested live curriculum runs plus the historical psi=0.3 reference."""
...
PREVIOUS = PROJECT / "analysis" / "psi_curriculum_seed2_seed32_vs_ref_20260817"
METRIC = "agent0/system_performance_true_all_GUs"
TOTAL_STEPS = 60_000_000
TZ = ZoneInfo("Asia/Shanghai")

# Okabe-Ito palette.  The distinct line styles and explicit labels provide a
# second cue in addition to color for red-green color-vision deficiency.
RUNS = [
    {
    ...
    },
    {
        ...
        "color": "#009E73",
        "linestyle": "-",
        "path": PREVIOUS / "data" / "remote" / "psi0p5.tfevents",
        "kind": "live",
    },
    {
        ...
        "color": "#D55E00",
        "linestyle": "-",
        "path": PREVIOUS / "data" / "remote" / "psi0p7.tfevents",
        "kind": "live",
    },
    {
        ...
        "color": "#CC79A7",
        "linestyle": "-",
        "path": PREVIOUS / "data" / "remote" / "psi0p9.tfevents",
        "kind": "live",
    },
    {
        "label": "remote psi=0.3 | seed=42 | historical reference",
        "color": "#000000",
        "linestyle": "--",
...
def main() -> None:
    ...
    for run in RUNS:
        ...
        eta = None
        if run["kind"] == "live" and math.isfinite(speed) and speed > 0:
