"""Reviewer-metric bars plus system-gain line for the fixed-flight psi sweep."""
...
# Keep the original three colors and add one colorblind-friendly teal series.
BAR_COLORS = ["#0072B2", "#E69F00", "#CC79A7", "#009E73"]
GAIN_COLOR = "#000000"
...
def main() -> None:
    ...
    metric_specs = (
        ...
        ("cpu_useful_utilization", "Resource utilization"),
    )
    ...
    # Adjacent bars within one psi group; the unit x spacing leaves a gap
    ...
    ax.set_title(
        "Offloading, completion, resource utilization, and system gain vs. ψ_min\n"
        "(25 deterministic episodes, fixed flight branch ψ=0.5)"
    )
