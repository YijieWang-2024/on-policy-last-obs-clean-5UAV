"""Evaluate the six current association-threshold checkpoints on 3 episodes."""
...
def load_base():
    spec = importlib.util.spec_from_file_location("association_eval_refresh_six", BASE_SCRIPT)
...
def main() -> None:
    ...
    output_name = os.environ.get(
        "DCPPO_EVAL_OUTPUT",
        "trajectory_eval_3_refresh_20260816",
    )
